...
struct AnalyticsConfig {
    ...
    nonisolated static func fromBundle() -> AnalyticsConfig {
        // VOCA does not inherit another product's analytics project or consent.
        if Bundle.main.bundleIdentifier?.hasPrefix("com.voca.") == true {
            return AnalyticsConfig(postHogApiKey: "", postHogHost: Self.defaultEUHost)
        }
