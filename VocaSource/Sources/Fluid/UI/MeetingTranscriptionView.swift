...
struct MeetingTranscriptionView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            VocaPageHeader(title: "Transcribe a File", subtitle: "Turn a recording into something you can read, search, and share.", symbol: "doc.waveform")
                .frame(maxWidth: 900).padding(.horizontal, 32).padding(.top, 32).padding(.bottom, 24)
