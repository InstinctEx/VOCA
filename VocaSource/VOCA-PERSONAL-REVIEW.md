...
Live UI verification exercised synthetic writing samples through analysis and the editable draft, then discarded the draft and confirmed samples cleared. No personal sample was uploaded. The restored helper and website were also inspected through the UI. Cross-application insertion and conservative recovery had prior TextEdit checks; this is not a certification of every editor.
